...
<head>
    ...
    <title>4SITIC  Admin - Modifier sous module</title>
...
<?php include_once "header_admin.php" ?>
    <div class="container">
        ...
        ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <input type="text" name="titre" placeholder="Titre *" value="<?= $post["titre_s_module"] ?>">
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    <textarea name="contenu" placeholder="Corps de l'article *"><?= str_replace("<br />","",$post["contenu_s_module"]) ?></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12">
